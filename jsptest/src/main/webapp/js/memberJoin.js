...
function idCheck() {
	...
	document.getElementById("idOverlapCheck").style = "display: none";
	...
	if (frm.inputId.value === '') {
		...
		document.getElementById('inputIdError').innerHTML = "*아이디:5~10자의 영문 소문자, 숫자와 특수기호(_)(-)만 사용 가능합니다.";
		return false;
	} else {
		document.getElementById("inputIdTr").className = "input";
		document.getElementById("idOverlapCheck").style = "";
		return true;
	}
}
function pwCheck() {
